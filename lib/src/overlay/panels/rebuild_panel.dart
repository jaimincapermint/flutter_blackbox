...
class RebuildPanel extends StatelessWidget {
  const RebuildPanel({super.key});

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<Map<String, int>>(
      stream: BlackBox.instance.rebuildStore.stream,
      initialData: BlackBox.instance.rebuildStore.counts,
      builder: (context, snapshot) {
        final entries = BlackBox.instance.rebuildStore.sortedEntries;
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  StreamBuilder<bool>(
                    stream: Stream.value(
                        BlackBox.instance.isAutoRebuildTrackingEnabled),
                    builder: (ctx, snap) {
                      final isEnabled =
                          BlackBox.instance.isAutoRebuildTrackingEnabled;
