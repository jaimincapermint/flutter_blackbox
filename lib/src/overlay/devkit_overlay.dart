...
class _BlackBoxOverlayState extends State<BlackBoxOverlay>
  ...
  // Shake detection.
  // Full shake detection requires sensors_plus (devkit_sensors companion).
  ...
  /// Entry point for shake detection from devkit_sensors companion.
  ...
  void _setupTrigger() {
    ...
    switch (trigger) {
      ...
      case ShakeTrigger():
      // Full shake requires sensors_plus via devkit_sensors companion.
