...
class _BlackBoxDioInterceptor extends Interceptor {
  ...
  Future<void> onRequest(
    ...
    options.extra['devkit_request_id'] = id;
    options.extra['devkit_start_ms'] = DateTime.now().millisecondsSinceEpoch;
    ...
    if (mock != null) {
      final startMs = options.extra['devkit_start_ms'] as int;
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) {
    final id = err.requestOptions.extra['devkit_request_id'] as String?;
    final startMs = err.requestOptions.extra['devkit_start_ms'] as int?;
    if (id == null) {
      handler.next(err);
      return;
    }
  ...
  void _recordResponse({
    ...
    final id = requestOptions.extra['devkit_request_id'] as String?;
    final startMs = requestOptions.extra['devkit_start_ms'] as int?;
    if (id == null) return;
